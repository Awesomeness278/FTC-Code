...
public class Autonomous extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        waitForStart();
        MoveTest test = new MoveTest(12,84,States.Start);
        test.Run(machine);
        test = new MoveTest(12,48,States.Start);
        test.Run(machine);
        while(opModeIsActive()&&getRuntime()<26){}
        test = new MoveTest(12,72,States.Start);
        test.Run(machine);
        stop();
//        initVuforia();
//        initTfod();
