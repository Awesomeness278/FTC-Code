    ...
    public void Run(StateMachine machine) {
        ...
        if (opMode.recognition != null) {
            if (opMode.recognition.getLabel().equals("Quad")) {
                if(opMode.position>=2&&opMode.position<=3){
                    pathY = AutonomousData.getInstance().getWobblePathY();
                }else{
                    pathY = AutonomousData.getInstance().getWobbleYPosition4();
                }
                machine.addState(States.WobblePathMove,new MoveTest(AutonomousData.getInstance().getWobblePathX4(),pathY,States.MoveToWobblePosition));
                ...
                machine.addState(States.MoveToLine, new MoveTest(AutonomousData.getInstance().getLineXPosition4(),AutonomousData.getInstance().getLineYPosition4(),States.Stop));
                ...
                if(opMode.position>=2&&opMode.position<=3){
                    ...
                    pathY = AutonomousData.getInstance().getWobbleYPosition1();
                }
                machine.addState(States.WobblePathMove,new MoveTest(AutonomousData.getInstance().getWobblePathX1(),pathY,States.MoveToWobblePosition));
                ...
                machine.addState(States.MoveToLine, new MoveTest(AutonomousData.getInstance().getLineXPosition1(),AutonomousData.getInstance().getLineYPosition1(),States.Stop));
                machine.addState(States.StraightenAfterWobble,new Rotate(0,States.MoveToLine));
            }
        } else {
            if(opMode.position>=2&&opMode.position<=3){
                ...
                pathY = AutonomousData.getInstance().getWobbleYPosition0();
            }
            if(Double.isNaN(AutonomousData.getInstance().getWaitYPosition())){
                machine.addState(States.WobblePathMove,new MoveTest(AutonomousData.getInstance().getWobblePathX0(),pathY,States.MoveToWobblePosition));
                ...
                machine.addState(States.MoveToWobblePosition, new MoveTest(AutonomousData.getInstance().getNoRingXPosition(), AutonomousData.getInstance().getWobbleYPosition0(), States.RotateToWobble));
                machine.addState(States.RotateToWobble, new Rotate(AutonomousData.getInstance().getWobbleRotation0(), States.DropWobble));
                machine.addState(States.MoveToLine, new MoveTest(AutonomousData.getInstance().getLineXPosition0(), AutonomousData.getInstance().getLineYPosition0(), States.Park));
